...
class SharedVariables {
    constructor() {
        ...
        this.lineThickness = new Variable(10);
        this.lineColor = new Variable("#FFBB00");
...
class ToolBar {
    constructor(sharedVariables) {
        ...
        this.buttons = [this.penButton, /*this.addButton,*/ this.eraserButton, this.cursorButton, this.handButton];
        this.penPopUp = null;
        this.addPopUp = null;
